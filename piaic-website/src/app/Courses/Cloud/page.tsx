...
export default function Cloud() {
    return (
        <section className="container mx-auto rounded-[30px] bg-[#2E294E] xs:max-w-[520px] md:max-w-[900px] lg:max-w-7xl xs:mt-12 md:mt-16 lg:mt-20 pb-7 p-4">
            <div>
                <h1 className="text-center font-semibold leading-tight xs:text-[18px] md:text-[30px] lg:text-[40px]"><span className="headingSpan">C</span>LOUD
                    <span className="headingSpan"> N</span>ATIVE <span className="headingSpan"> P</span>ROGRAMMING</h1>
                <p className="text-center xs:text-[12px] md:text-[18px] md:leading-6 lg:text-[22px] lg:leading-8">A ONE YEAR AI PROGRAM DESIGNED FOR ABSOLUTE BEGINNERS.GETTING
            ...
            <div class="mt-6"> {/*Specialised Courses */}
                ...
                <div class="container mx-auto mt-5 flex place-content-center items-center xs:gap-3 md:gap-x-4 lg:gap-x-8" >
                    <a href="https://panaverse-sable.vercel.app/Cloud" class="hover:bg-white hover:text-black hover:scale-125">
