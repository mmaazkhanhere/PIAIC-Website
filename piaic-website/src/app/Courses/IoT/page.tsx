...
export default function IoT() {
    return (
        <section className="container mx-auto rounded-[30px] bg-[#2E294E] sm:max-w-[520px] md:max-w-[900px] lg:max-w-7xl sm:mt-12 md:mt-16 lg:mt-20 pb-7 p-4 sm:mb-14 md:mb-20 lg:mb-28">
            <div>
                <h1 className="text-center font-semibold leading-tight sm:text-[18px] md:text-[30px] lg:text-[40px]"><span className="headingSpan">I</span>NTERNET
                ...
                <p className="text-center sm:text-[12px] md:text-[18px] md:leading-6 lg:text-[22px] lg:leading-8">A FIFTEEN MONTHS IOT AND AI PROGRAM DESIGNED FOR ABSOLUTE BEGINNERS
