...
export default function Courses() {
    return (
        <section className="container mx-auto rounded-[30px] bg-[#2E294E] xs:max-w-[520px] md:max-w-[900px] lg:max-w-7xl xs:mt-6 md:mt-8 lg:mt-10">
            <div>
            ...
            <div className="mt-6">
                ...
                <div className="container mx-auto mt-5 flex place-content-center items-center xs:gap-3 md:gap-x-4 lg:gap-x-8">
                    <a href="https://panaverse-sable.vercel.app/Quarter-1" className="hover:bg-white hover:text-black">
                    ...
                    <a href="https://panaverse-sable.vercel.app/Quarter-2" className="hover:bg-white hover:text-black">
                    ...
                    <a href="https://panaverse-sable.vercel.app/Quarter-3" className="hover:bg-white hover:text-black">
                        <div className="coreCourses container flex">
