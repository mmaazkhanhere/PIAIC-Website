...
export default function WIT() {
    return (
        <>
            <section className="container mx-auto mt-10 rounded-3xl bg-[#2E294E] p-12 text-white">
                <div className="container flex flex-col place-items-center">
                    <div>
                        <img src="https://env-4607159.sekd1.beebyteapp.io/wp-content/uploads/2021/11/WIT-Logo_Black1-1024x396-1.png" alt="" className="lg:w-[700px]" />
                    </div>

                    <div className="mt-8 text-justify lg:pl-12 lg:pr-12">
